...
public class FragmentQuestion4 extends Fragment {
    ...
    String question4 = "Have you Been To Masses or crowds or places with a lot of people?";
    ...
    private void SaveToDb(String answer) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                RootRef.child(Getimei.getIMEI(getActivity())).child("question4").setValue(answer);
                loadingBar.dismiss();
