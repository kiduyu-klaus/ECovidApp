...
public class FragmentQuestion5 extends Fragment {
    ...
    String question5 = "Have you recently travelled to counties with high number of infected people, like Nairobi?";
